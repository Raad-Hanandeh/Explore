      ...
      <section className="max-w-screen-xl mx-auto  mt-24 py-24 px-2 xl:px-0" >
        <div className="grid grid-cols-1 lg:grid-cols-2  justify-items-center">
          ...
          <div className=" max-w-lg border border-black-soft rounded-2xl mt-12 xl:mt-0">
            ...
            <div className="flex gap-6 border-t  rounded-2xl border-black-soft px-12 py-6 font-DM-Sans">
              <img src="./img/Icon2.svg" alt="item" />
              <div>
                <h5 className=" text-14 xl:text-16 font-bold text-black-soft">Sustainable Travel</h5>
                <p className=" text-14 xl:text-16 font-normal text-black-soft opacity-75">Committed to responsible and eco-conscious journeys, traveling the world with minimal footprints and pollutions.</p>
              
              </div>
            </div>
            <div className="flex gap-6 border-t  border-black-soft rounded-2xl  px-12 py-6 font-DM-Sans">
            ...
            <div className="flex gap-6 bg-black-soft rounded-2xl px-12 py-6 font-DM-Sans">
              ...
              <div>
                ...
                <p className=" text-14 xl:text-16 font-normal text-white opacity-75 ">Every journey will be led by knowledgeable, passionate experts who enhance your travel experience.</p>
      ...
      <section className="max-w-screen-xl mx-auto px-2 xl:px-0">
            <div className=" text-center sm:text-start sm:px-2 lg:px-0  mt-24">
                <div className="flex sm:justify-between justify-center items-end ">
                  <h2 className=" text-36 xl:text-64  text-black-soft font-normal  xl:max-w-md"><span className=" font-DM-Sans">Real</span> <span className=" font-Playfair-Display italic">stories</span> <span className=" font-DM-Sans">from travelers</span></h2>
          ...
          <div className=" flex flex-col justify-center items-center">
            ...
            <div className=" bg-gray-soft py-12 px-4 xl:px-12 rounded-3xl mt-16">
                ...
                <div className="border-b border-black-soft py-2 mt-12">
                      <input className=" opacity-50 px-2   bg-transparent placeholder:text-16  placeholder:text-black-soft placeholder:font-DM-Sans placeholder:font-normal" type="text" placeholder="Email Address" />
              </div>
              <div className="flex flex-col lg:flex-row items-center justify-between mt-16">
                ...
                <div>
                <button className="text-white flex items-center  bg-black-soft font-DM-Sans rounded-full  font-bold gap-3 py-2 px-8 "><span>Subscribe Now</span> <img src="./img/Arrow-Icon.svg" alt="arrow" /></button></div>
                </div>
              </div>
          </div>
        </div>
